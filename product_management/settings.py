...
SECRET_KEY = "django-insecure-&i3d+c!$#59$3q04yi!ru8r(3%xs#r__cy2n^q3a0!v)(*+-_8"
...
DATABASES = {
    # change the default db using mysql
    "default": {
        "ENGINE": "django.db.backends.mysql",
        "NAME": "django_product_management",  # Replace with your desired database name
